  ...
  <body>
    ...
    <header class="header mb-5">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-right">
              <ul class="menu list-inline mb-0">
                <li class="list-inline-item"><a href="{$PAG_LOGIN}" data-toggle="modal" data-target="#login-modal">Login</a></li>
                <li class="list-inline-item"><a href="{$PAG_CONTA}">Minha conta</a></li>
                <li class="list-inline-item"><a href="{$PAG_FAVORITOS}">Favoritos</a></li>
                <li class="list-inline-item"><a href="{$PAG_CONTATO}">Contato</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <p class="text-center text-muted"><a href="{$PAG_CADASTRO}"><strong>Registrar-se agora</strong></a>! É fácil e feito em 1 minuto e dá acesso a descontos especiais e muito mais!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="{$GET_HOME}" class="navbar-brand home zoom"><img src="{$GET_TEMA}/img/logo.png" alt="Carline logo" class="d-none d-md-inline-block"><img src="{$GET_TEMA}/img/logo-small.png" alt="Carline logo" class="d-inline-block d-md-none"><span class="sr-only">Carline - Página Inicial</span></a>
          <div class="navbar-buttons">
            <button type="button" data-toggle="collapse" data-target="#navigation" class="btn btn-outline-secondary navbar-toggler"><span class="sr-only">Toggle navigation</span><i class="fa fa-align-justify"></i></button>
            <button type="button" data-toggle="collapse" data-target="#pesquisar" class="btn btn-outline-secondary navbar-toggler"><span class="sr-only">Pesquisar</span><i class="fa fa-search"></i></button><a href="{$GET_CARRINHO}" class="btn btn-outline-secondary navbar-toggler"><i class="fa fa-shopping-cart"></i></a>
          </div>
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item"><a href="{$GET_HOME}" class="nav-link active">Início</a></li>
                ...
                <ul class="dropdown-menu megamenu">
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3">
                        <div class="banner"><a href="{$GET_TEMA}"><img src="{$GET_TEMA}/img/banner.jpg" alt="" class="img img-fluid"></a></div>
                        <div class="banner"><a href="{$GET_TEMA}"><img src="{$GET_TEMA}/img/banner2.jpg" alt="" class="img img-fluid"></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
                  ...
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3">
                        <h5>Order process</h5>
                        <ul class="list-unstyled mb-3">
                          <li class="nav-item"><a href="{$GET_CARRINHO}" class="nav-link">Carrinho</a></li>
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              ...
              <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="{$GET_CARRINHO}" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span></span></a></div>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div class="row">
            <div class="col-md-12">
              <div id="main-slider" class="owl-carousel owl-theme">
                <div class="item"><img src="{$GET_TEMA}/img/slide1.png" alt="" class="img-fluid"></div>
                <div class="item"><img src="{$GET_TEMA}/img/slide2.png" alt="" class="img-fluid"></div>
                <div class="item"><img src="{$GET_TEMA}/img/slide3.png" alt="" class="img-fluid"></div>
                <div class="item"><img src="{$GET_TEMA}/img/slide4.png" alt="" class="img-fluid"></div>
                <div class="item"><img src="{$GET_TEMA}/img/slide5.png" alt="" class="img-fluid"></div>
                <!--<div class="item"><img src="{$GET_TEMA}/img/main-slider4.jpg" alt="" class="img-fluid"></div>-->
              </div>
              <!-- /#main-slider-->
            </div>
          </div>
            ...
            <div class="product-slider owl-carousel owl-theme">
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/1.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/2.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/3.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/5.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/6.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/7.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/9.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/10" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/9.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/7.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/8.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/8.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/3.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/4.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/4.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/product1.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/product1_2.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/product1.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/product2.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/product2_2.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/product2.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{$GET_TEMA}/img/product3.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{$GET_TEMA}/img/product3_2.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{$GET_TEMA}/img/product3.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
          ...
          <div class="col-md-12">
            <div class="box slideshow">
              ...
              <div id="get-inspired" class="owl-carousel owl-theme">
                <div class="item"><a href="#"><img src="{$GET_TEMA}/img/slide1b.jpg" alt="Get inspired" class="img-fluid"></a></div>
                <div class="item"><a href="#"><img src="{$GET_TEMA}/img/slide2b.jpg" alt="Get inspired" class="img-fluid"></a></div>
                <div class="item"><a href="#"><img src="{$GET_TEMA}/img/slide3b.jpg" alt="Get inspired" class="img-fluid"></a></div>
                <div class="item"><a href="#"><img src="{$GET_TEMA}/img/slide1b.jpg" alt="Get inspired" class="img-fluid"></a></div>
              </div>
            </div>
          </div>
